...
export default defineConfig([
  ...
  ...tseslint.configs.stylistic,
  {
    ...
    settings: { playwright: { globalAliases: { test: ['marketTest'] } } },
  },
  {
    languageOptions: {
      ecmaVersion: 'latest',
    ...
    rules: {
      ...
      '@typescript-eslint/member-ordering': [
        'error',
        { default: { memberTypes: ['signature', 'field', 'constructor', 'method', 'private-method'] } },
      ],
      ...
      'no-restricted-syntax': [
        ...
        { message: 'Use arrow functions instead of function declarations.', selector: 'FunctionDeclaration' },
        {
      ...
      'perfectionist/sort-classes': [
        ...
        {
          customGroups: [
            { elementNamePattern: 'url', groupName: 'url-property' },
            {
          ...
          groups: [
            ...
            'url-property',
            { newlinesBetween: 0 },
            { group: 'readonly-property', newlinesInside: 0 },
            { newlinesBetween: 0 },
            ...
            { newlinesBetween: 1 },
            { group: 'function-property', newlinesInside: 1 },
            'method',
            { newlinesBetween: 1 },
            { group: ['private-function-property', 'private-method'], newlinesInside: 1 },
            'unknown',
          ],
          order: 'asc',
          type: 'alphabetical',
      ...
      'unicorn/numeric-separators-style': [
        'error',
        { number: { groupLength: 3, minimumDigits: 0 }, onlyIfContainsSeparator: false },
      ],
    },
  },
  {
